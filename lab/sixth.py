"""
Cоздайте документацию как для самих разработанных классов, так и для их методов,
согласно варианта индивидуального задания;
• используйте перегрузку арифметических операций (+, -, *, /) в своих классах;
• протестируйте корректность выполнения перегруженных операций с помощью
unittest.

Методы mul и truediv не перегружены у Route, Garage по причине отсутствия атрибутов для адекватных операций
"""
